...
#loads temp & humidity with sensor and saves in JSON format
...
if(abs(humidity1 - humidity2) > 2 or abs(temperature1 - temperature2) > 2 or temperature1 < -200 or temperature2 < -200or humidity1 < -200 or humidity2 < -200):
 print("Problem")
else:
